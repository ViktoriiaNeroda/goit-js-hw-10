...
var _catApi = require("./js/cat-api");
...
(0, _catApi.fetchBreeds)().then((data)=>{
    ...
    Notiflix.Report.warning("Sorry, try again", {
        width: "320px",
        svgSize: "30px",
...
ref.selectBread.addEventListener("change", (evt)=>{
    if (!isFirstSelection) {
        ...
        (0, _notiflixReportAio.Report).success("Great!", ";) Okay", {
            width: "320px",
            svgSize: "50px",
            messageFontSize: "16px",
    ...
    (0, _catApi.fetchCatImg)(selectedBreedId).then((data)=>{
...
},{"./js/cat-api":"5IWAT","./styles.css":"lW6qc","slim-select":"lzHUr","notiflix/build/notiflix-report-aio":"hNopu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5IWAT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "apithecatApi", ()=>apithecatApi);
parcelHelpers.export(exports, "fetchBreeds", ()=>fetchBreeds);
parcelHelpers.export(exports, "fetchCatImg", ()=>fetchCatImg);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _notiflix = require("notiflix");
var _notiflixDefault = parcelHelpers.interopDefault(_notiflix);
(0, _axiosDefault.default).defaults.headers.common["x-api-key"] = "live_5nVcm90UjcYCONd9Zs2kschF0jkgo3s2QaiMfSC29wag3Gq3MUs29a71K8YESRT7";
const apithecatApi = (0, _axiosDefault.default).create({
    baseURL: "https://api.thecatapi.com"
});
const fetchBreeds = ()=>{
    return apithecatApi.get("/v1/breeds").then((response)=>{
        if (response.status !== 200) throw new Error(response.status);
        return response.data;
    }).catch((error)=>{
        console.log(error);
        (0, _notiflixDefault.default).Report.warning("Sorry, try again", {
            width: "320px",
            svgSize: "30px",
            messageFontSize: "16px",
            backgroundColor: "purple",
...
const fetchCatImg = (breedId)=>{
    return apithecatApi.get(`/v1/images/search?breed_ids=${breedId}`).then((response)=>{
        if (response.status !== 200) throw new Error(response.status);
        return response.data;
    }).catch((error)=>{
        (0, _notiflixDefault.default).Report.warning("Sorry, try again!", {
...
},{}],"lW6qc":[function() {},{}],"lzHUr":[function(require,module,exports) {
